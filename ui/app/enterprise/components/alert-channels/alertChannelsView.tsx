...
export { default } from "../../../_fallbacks/enterprise/components/alert-channels/alertChannelsView";
export * from "../../../_fallbacks/enterprise/components/alert-channels/alertChannelsView";
