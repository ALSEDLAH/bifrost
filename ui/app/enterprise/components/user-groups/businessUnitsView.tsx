// Enterprise business units view — wraps the governance customer management.
// governance_customers = organizations/business units in enterprise mode.
...
export function BusinessUnitsView() {
	...
	const { data: teamsData, error: teamsError, isLoading: teamsLoading } = useGetTeamsQuery(undefined, {
	...
	const { data: customersData, error: customersError, isLoading: customersLoading } = useGetCustomersQuery(
		...
		{ skip: !hasCustomersAccess, pollingInterval: POLLING_INTERVAL },
	);
