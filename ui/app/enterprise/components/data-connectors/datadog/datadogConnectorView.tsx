// Enterprise stub for Datadog Log Export (spec 002, US2).
...
export default function StubView() {
	return (
		<FeatureStatusPanel
			title="Datadog Log Export"
			description="Stream Bifrost request logs to Datadog. Needs its own spec to add the logexport plugin + Datadog sink."
			status="descoped"
			trackingLink={{
